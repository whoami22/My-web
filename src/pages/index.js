			...
			<Stack>
				...
				<StackItem display="flex" quarkly-title="Logo" md-width="75%" width="25%">
					...
					<Link href="/" position="relative" transition="opacity 200ms ease" quarkly-title="Link">
						<Image src="https://uploads.quarkly.io/5f44d0da669357001e60ed14/images/default-website-logo.svg?v=2020-11-06T17:26:21.226Z" width="120px" z-index="3" text-transform="uppercase" />
					</Link>
				</StackItem>
